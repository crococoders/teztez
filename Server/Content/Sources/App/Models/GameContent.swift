...
//                word.replaceSubrange(Range(result.range, in: String(word))!, with: word[Range(result.range, in: word)!].reversed())
//            }
...
//
//            for result in results {
//                word.replaceSubrange(Range(result.range, in: String(word))!, with: word[Range(result.range, in: word)!].shuffled())
//            }

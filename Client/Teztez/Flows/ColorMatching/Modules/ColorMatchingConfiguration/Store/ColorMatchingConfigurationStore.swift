...
final class ColorMatchingConfigurationStore {
    ...
    init() {
        headerViewModel = ActivityHeaderViewModel(title: R.string.colorMatchingConfiguration.title(),
                                                  description: R.string.colorMatchingConfiguration.description(),
                                                  iconViewModel: ActivitiesIconViewModel(type: .colorMatch))
        selectValueViewModel = ActivitySelectValueViewModel(title: R.string.colorMatchingConfiguration.durationTitle(),
                                                            description: R.string.colorMatchingConfiguration.durationDescription(),

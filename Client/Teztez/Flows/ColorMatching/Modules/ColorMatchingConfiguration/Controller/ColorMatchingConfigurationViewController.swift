...
final class ColorMatchingConfigurationViewController: ViewController, ColorMatchingConfigurationPresentable {
    ...
    func enablePauseMode() {
        ...
        startButton.setTitle(R.string.matching.continue(), for: .normal)
        startButton.tag = 1
    }
    ...
    private func setupLocalization() {
        startButton.setTitle(R.string.matching.start(), for: .normal)
        restartButton.setTitle(R.string.matching.restart(), for: .normal)
    }
